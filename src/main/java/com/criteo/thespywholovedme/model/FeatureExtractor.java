...
public class FeatureExtractor {
    ...
    public List<List<Double>> extractFeatures(List<TermIDF> dictionary, List<Map<String, Integer>> posResumes, List<Map<String, Integer>> negResumes) {
     ...
     * MatrixUtils.createRealMatrix(matrixData); SingularValueDecomposition svd
     * = new SingularValueDecomposition(m);
     *
     * // compute the singular vallue decomposition RealMatrix U = svd.getU();
     * RealMatrix S = svd.getS(); RealMatrix V = svd.getV(); US =
     * svd.getU().multiply(S); RealMatrix VS = svd.getV().multiply(S); return
     * VS;
     *
     * }
     *
